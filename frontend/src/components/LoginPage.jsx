        ...
        <div className="bg-slate-800 rounded-2xl shadow-2xl border border-slate-700 p-8">
          <div className="flex items-center gap-3 mb-6 justify-center">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">RHEL Backup System</p>
            </div>
          </div>

          <div className="mb-6 text-center">
            <h2 className="text-xl font-semibold text-white mb-2">Sign In</h2>
            <p className="text-slate-400 text-sm">Access your backup management system</p>
          </div>
          ...
          {googleAuthEnabled && (
            <>
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold py-3 px-6 rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mb-6"
              >
          ...
          <div className="text-center">
            <p className="text-slate-400 text-sm">
              Default credentials: <span className="text-slate-300 font-medium">admin / password</span>
            </p>
          </div>
        </div>
      </div>
